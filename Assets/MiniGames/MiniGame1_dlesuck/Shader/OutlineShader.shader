...
//
//
//           vertexOutput vert(vertexInput v,inout surfaceOutput x) {
//
//              vertexOutput o;
//              o.pos = UnityObjectToClipPos(v.vertex);
//              o.texcoord.xy = (v.texcoord.xy * _MainTex_ST.xy + _MainTex_ST.zw);
//              x.Normal=UnpackNormal(tex2d(_BumpMap,in.UV_BumpMap))
//              return o;
//           }
//
//
//           //--------------------------------------------------
//           float4 LightingToon(vertexOutput s, float3 lightDir, float atten) {
...
//               float4 final;
//
//               final.rgb = s.texcoord * ndotl * _LightColor0.rgb;
//               final.a = 1;
//
//               return final;
//           }
//           half4 frag(vertexOutput i, LightingToon q) :COLOR
//           {
//           return tex2D(_MainTex,i.texcoord) * _Color * q.final;
//
//           }
//
//        ENDCG
